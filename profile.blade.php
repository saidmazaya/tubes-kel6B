                    ...
                    <div class="d-flex flex-row align-items-center">
                        <nav class="navbar navbar-expand-lg">
                            <ul class="nav navbar-nav navbar-expand-lg" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" style="color: rgb(0, 0, 0)" id="home-tab" data-toggle="tab"
                                        href="#" role="tab" aria-controls="home" aria-selected="true">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" style="color: rgb(0, 0, 0)" id="home-tab" data-toggle="tab"
                                        href="#" role="tab" aria-controls="list" aria-selected="true">List</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" style="color: rgb(0, 0, 0)" id="home-tab" data-toggle="tab"
                                        href="#" role="tab" aria-controls="about" aria-selected="true">About</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="image-container">
                        @if (Auth::user()->image != NULL)
                            <img src="{{ asset(str_replace('public', 'storage', Auth::user()->image)) }}" alt="profilepicture" class="rounded-image">
                        @else
                            <img src="/images/default-user-image.png" alt="aaaaaa" class="rounded-image">
                        @endif
                    </div>
                    
                    <div class="profile-head">
                        <h5>{{ Auth::user()->name }}</h5>
                        <h6><a href="#">999.237 Followers</a></h6>
                        <div class="d-flex flex-row align-items-center justify-content-between mt-3">
                            <div>
                                <p>{{Auth::user()->bio}}</p>
                                <h6><a href="/profile/{id}/edit" class="text-success mb-4">Edit Profile</a></h6>
