        ...
        <div class="col-md-8 align-items-center justify-content-center">
            <div class="d-flex flex-row align-items-center">
                <nav class="navbar navbar-expand-lg">
                    <ul class="nav navbar-nav navbar-expand-lg" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link nav-link-prof" style="color: rgb(0, 0, 0)" id="home-tab" data-toggle="tab" href="#" role="tab" aria-controls="home" aria-selected="true">Following</a>
                        </li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="tab-content" style="margin-left: 46px">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <h1 style="font-weight: bolder; margin-bottom: 40px">{{ $user->follows->count() }} Following</h1>
                ...
                <div class="d-flex flex-row align-items-center justify-content-between mt-3">
                    <div>
                        ...
                        <div class="profile-head mt-4">
                            <div>
                                <h6>Following</h6>
                                @foreach ($following->take(5) as $data)
                                <div class="d-flex flex-row align-items-center my-2">
                                    <div class="image-container-following-1">
                                        @if ($data->image != null)
                                        <img src="{{ asset('storage/photo/'.$data->image) }}" alt="profilepicture" class="rounded-image">
                                        @else
                                        <img src="/images/default-user-image.png" alt="" class="rounded-image">
